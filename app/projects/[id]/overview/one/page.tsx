          ...
          <main className="p-6 text-white bg-[#0f0f0f] min-h-screen pt-32 w-full">
            ...
            >
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                ...
                impact the safety of citizens and the regulatory framework of
                fire safety.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                Our goal was not just to digitize the fire inspection process
                but to address these critical issues within the safety system.
                We needed to build a solution that supports both administrative
                needs and operational challenges in a sensitive industry.
              </p>
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                • Provide Transparency: Ensure clear and easily accessible
                records for both federal and state agencies, improving
                accountability.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                • Enforce Compliance: Issue fines for buildings that fail to
              ...
              <div className="flex flex-col gap-6 w-full mx-auto">
                <Image src={Firstimage} alt="" width={869} />
              </div>
            </section>
            ...
            >
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                Our first step was to conduct extensive research to understand
                the operational challenges of fire service organizations. This
                included visiting several fire stations across different regions
                to gain insight into the scope of their work and the hurdles
                they face. Key takeaways included:
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                • Jurisdictional Conflicts: The lack of clear boundaries in
                authority between federal and state fire service organizations
                was hindering smooth operations.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                • Historical Record Gaps: Many records were either lost or
                stored manually, making it difficult to track past inspections
                and certifications.
              </p>
              <h2 className="text-[32px] font-semibold bg-gradient-to-r from-[#F3F3F3] to-[#434242] text-transparent bg-clip-text">
              ...
              <div className="flex flex-col gap-6 w-full mx-auto">
                <Image src={Secondimage} alt="" width={869} />
                <Image src={Thirdimage} alt="" width={869} />
                <Image src={Fourthimage} alt="" width={869} />
              </div>
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                Our first draft of the system dashboard focused on key metrics
                for efficient tracking and decision-making:
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                • <strong>Key Metrics Boxes:</strong> The dashboard displays
                four key performance indicators—number of fire certificates
                issued, number of insurance certificates issued, upcoming
                inspections, and net revenue from transactional flows.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                •<strong> Activity Feeds:</strong> To address the historical
                record issue, we implemented activity feeds that track every
                action performed by officers. This allows higher-level officers
                to monitor and review all activities within their jurisdictions,
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                ...
                indicators, number of fire certificates issued, number of
                insurance certificates issued, upcoming inspections, and net
                revenue from transactional flows.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                • Activity Feeds: To address the historical record issue, we
                implemented activity feeds that track every action performed by
                officers. This allows higher-level officers to monitor and
                review all activities within their jurisdictions, ensuring
            ...
            >
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                1. <strong> The Importance of Fieldwork:</strong> I learned that
                a designer&apos;s role goes beyond just creating wireframes;
                understanding the real-world context is crucial for designing
                effective solutions. Without interacting with the actual users,
                we might miss key pain points or misinterpret the needs.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                2. <strong>Collaboration is Key: </strong> Working with a
                diverse team of over a dozen professionals helped me appreciate
                the power of teamwork. It became evident that even the most
                conventional processes could be improved through thoughtful
                digital solutions.
              </p>
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
            ...
            >
              ...
              <p className="text-[20px] md:text-2xl text-[#CDCDCD] ">
                Our solution BFICS has provided a much-needed overhaul of the
                fire inspection and certification process, tackling
                inefficiencies while ensuring accountability. As the
                implementation phase progresses, we are excited to see the
                positive impact this system will have on fire safety and
                building insurance compliance across Nigeria.
              </p>
              <h1 className="text-[28px] md:text-5xl font-semibold bg-gradient-to-r from-[#F3F3F3] to-[#434242] text-transparent bg-clip-text">
                Thanks for reading!
              </h1>
